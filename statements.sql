...
UPDATE usuarios SET id_rol = 2 WHERE id_usuario = 16;
...
UPDATE usuarios SET id_rol = 4 WHERE id_usuario = 21;



-- PASO 4
-- Tu código aquí
SELECT usuarios.id_usuario,usuarios.nombre,usuarios.apellido,usuarios.email,usuarios.edad,roles.nombre_rol FROM usuarios JOIN roles ON usuarios.id_rol = roles.id_rol ORDER BY usuarios.id_usuario ASC;
